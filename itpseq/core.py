...
class Sample:
    ...
    def DE(
        ...
        **kwargs: optional
        ...
        Include the read counts for each replicate, the average count per million reads,
        and the sample/reference ratio of the normalized counts.
    ...
    def volcano(
        ...
        **kwargs,
        ...
        Use the adjusted p-value for the Y-axis.

         >>> sample.volcano('-2:A', y='log10padj')

        .. image:: /_static/sample_volcano_log10padj.png
        """
